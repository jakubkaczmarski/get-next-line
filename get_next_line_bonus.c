...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/27 12:51:18 by jkaczmar          #+#    #+#             */
/*   Updated: 2021/12/27 15:40:31 by jkaczmar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_buffjoin(char **line, char *buff)
{
	...
	index = 0;
	counter = 0;
	index = ft_strlen(line[0]) + ft_strlen(buff) + 1;
...
static void	ft_movetonextnewline(char *buff)
{
	...
	lenghtofwholebuff = ft_strlen(buff);
	linelenght = lenghtofwholebuff - ft_strlen(ft_strrchr(buff, '\n') + 1);
